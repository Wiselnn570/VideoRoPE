...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def _compute_lens(self, inter_data: InterDataForSeqGroup, seq_idx: int,
        ...
        #! pass parameters
        if seq_group_metadata.multi_modal_data is not None:
            self.which_rope = seq_group_metadata.multi_modal_data.get('which_rope', 'm_rope')
            self.scale_factor = seq_group_metadata.multi_modal_data.get('scale_factor', 1.0)
            self.runner.model_config.which_rope = self.which_rope
            self.runner.model_config.scale_factor = self.scale_factor
        else:
            self.which_rope = self.runner.model_config.which_rope
            self.scale_factor = self.runner.model_config.scale_factor
    ...
    def _compute_multi_modal_input(self, inter_data: InterDataForSeqGroup,
        ...
        if self.runner.model_is_mrope:
            ...
            for seq_idx in range(inter_data.n_seqs):
                ...
                # TOMODIFY /mnt/petrelfs/weixilin/miniconda3/envs/qwen2-vl/lib/python3.10/site-packages/vllm/model_executor/layers/rotary_embedding.py:786
                ...
                #! apply videorope when inference 
    ...
    def build(self) -> ModelInputForGPU:
        ...
        input_tokens_tensor = async_tensor_h2d(input_tokens, torch.float,
                                               self.runner.device,
