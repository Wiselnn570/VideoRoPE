...
if __name__ == "__main__":
    ...
    args.add_argument("--needle_dataset", type=str, default="/mnt/petrelfs/weixilin/projects/MLLM/Qwen2-VL/vision_niah/needle_datasets/dataset_counting.json")
    args.add_argument("--min_frame_num", type=int, default=200)
    args.add_argument("--frame_interval", type=int, default=100)
    args.add_argument("--output_path", type=str, default="/mnt/petrelfs/weixilin/projects/MLLM/Qwen2-VL/vision_niah/niah_output_counting")
